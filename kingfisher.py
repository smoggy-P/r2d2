...
class R2D2GlobalFeatureNode:
    ...
    def _load_parameters(self):
        ...
        self.enable_occupied_check = rospy.get_param('~enable_occupied_check', False)
        ...
        self.sync_queue_size = rospy.get_param('~sync_queue_size', 1)
    ...
    def _init_ros_communication(self):
        ...
        self.image_sub = message_filters.Subscriber('/zedm/zed_node/rgb/image_rect_color', Image)
        self.depth_sub = message_filters.Subscriber("/zedm/zed_node/depth/depth_registered", Image)
